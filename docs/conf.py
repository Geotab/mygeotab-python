# -*- coding: utf-8 -*-
#
# Sphinx configuration for the MyGeotab Python SDK documentation.
...
# Furo theme requires Sphinx ≥ 5.0; sphinx-copybutton ≥ 0.5 needs 5.x as well.
needs_sphinx = "7.0"
...
copyright = "{}, {}".format(datetime.datetime.now(datetime.timezone.utc).year, mygeotab.__author__)
